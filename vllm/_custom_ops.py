...
def sm120_fp8_blockscale_moe_gemm(
    ...
    FP8 E4M3 data with FP32 blockwise scales on SM120 (Blackwell GeForce).
    Uses CUTLASS CollectiveBuilder with Sm120BlockwiseScaleConfig.
    ...
    Args:
        ...
        a_scales: [M_total, ceil(K/128)] FP32 blockwise scales for A
        b_scales: [num_experts, N, ceil(K/128)] FP32 blockwise scales for B
...
def sm120_fp8_blockscale_quant_a(
    ...
    """
    SM120 online BF16 → FP8+FP32 quantization for MOE activations.

    Quantizes BF16 activation tokens to FP8 E4M3 format with FP32 block
    scales. Scale layout is column-major [M, ceil(K/128)] matching
    CUTLASS Sm120BlockwiseScaleConfig's deduce_layoutSFA.

    Args:
        fp8_output: [M_total, K] FP8 E4M3 output tensor
        scale_output: [M_total, ceil(K/128)] FP32 blockwise scales
