...
class BlockTables:
    def __init__(
        ...
        for i in range(self.num_kv_cache_groups):
            ...
            max_num_blocks_per_group = max_num_blocks[i]
            ...
            if block_size <= 128:
                ...
                max_num_blocks_per_group = (
                    cdiv(max_num_blocks_per_group, alignment) * alignment
                )
            block_table = StagedWriteTensor(
                (self.max_num_reqs, max_num_blocks_per_group * blocks_per_kv_block),
                dtype=torch.int32,
                device=device,
            )
